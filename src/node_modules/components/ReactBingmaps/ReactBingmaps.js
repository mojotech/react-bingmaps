...
class ReactBingmaps extends Component {
	...
	setPushPins(pushPins, mapReference){		
		if(map[mapReference] && pushPins){
          ...
          if (pushPins[pushPinIndex].onClick) {
						Microsoft.Maps.Events.addHandler(pushpin, "click", pushPins[pushPinIndex].onClick);
					}
					if (pushPins[pushPinIndex].onMouseover) {
						Microsoft.Maps.Events.addHandler(pushpin, "mouseover", pushPins[pushPinIndex].onMouseover);
					}
					if (pushPins[pushPinIndex].onMouseout) {
						Microsoft.Maps.Events.addHandler(pushpin, "mouseout", pushPins[pushPinIndex].onMouseout);
					}
	...
	setPolylines(polylines, mapReference){
